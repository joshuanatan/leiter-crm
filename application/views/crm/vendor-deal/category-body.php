        ...
        <tbody>
            ...
            <tr class="gradeA">
                ...
                <td class="actions">
                    ...
                    <a href = "<?php echo base_url();?>crm/vendor/submit/<?php echo $a->id_request;?>" class="btn btn-outline btn-success" data-trigger = "hover" data-content = "Proceed to Quotation" data-toggle="popover"><i class="icon fa fa-check" aria-hidden="true"></i></a>
