                        ...
                        <div class="tab-content">
                            ...
                            <input type = "hidden" name = "id_request" value = "<?php echo $quotation["id_request"];?>">
                                ...
                                <div class = "form-group">
                                    ...
                                    <input name = "versi_quotation" id = "versi_quotation" value = "<?php echo $last_version;?>" readonly type ="text" class = "form-control">
                                </div>
                                <div class = "form-group">
                            ...
                            <div class="tab-pane" id="detail" role="tabpanel">
                                <div class = "form-group">
                                    ...
                                    <input value = "<?php echo $quotation["no_quotation"];?>/RV<?php echo $last_version-1;?>" type ="text" class = "form-control" readonly>
                                </div>
                                <div class = "form-group">
