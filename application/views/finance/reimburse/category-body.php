        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                                ...
                                <div class = "modal-content">
                                    ...
                                    <div class ="modal-body">
                                        ...
                                        <div class = "form-group">
                                            ...
                                            <input type = "text" oninput = "commas('paymentPay')" id = "paymentPay" class = "form-control" name = "nominal_pembayaran">
                                        </div>
                                        <div class = "form-group">
                    ...
                    <button class = "btn btn-primary btn-sm btn-outline" type="button" data-toggle = "modal" data-target="#detail<?php echo $a;?>">DETAIL</button>
                                ...
                                <form action = "<?php echo base_url();?>finance/reimburse/edit/<?php echo $reimburse[$a]["id_reimburse"]?>" method = "POST" enctype = "multipart/form-data">
                                    <div class = "modal-body">
                                        ...
                                        <div class = "form-group">
                                            ...
                                            <select class = "form-control" name = "expanses_edit" data-plugin = "select2">
        ...
        <div class = "modal-content">
            ...
            <form action = "<?php echo base_url();?>finance/reimburse/insert" method = "POST" enctype = "multipart/form-data">
                <div class = "modal-body">
                    ...
                    <div class = "form-group">
                        <h5 style = "opacity:0.5">Expanses</h5>
                        <select class = "form-control" name = "expanses" data-plugin = "select2">
                            <?php for($b = 0; $b<count($expanses_type); $b++):?>
