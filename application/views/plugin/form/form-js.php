...
<script src="<?php echo base_url();?>global/js/Plugin/bootstrap-tokenfield.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/bootstrap-tagsinput.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/bootstrap-select.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/icheck.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/switchery.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/asrange.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/ionrangeslider.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/asspinner.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/clockpicker.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/ascolorpicker.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/bootstrap-maxlength.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/jquery-knob.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/bootstrap-touchspin.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/card.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/jquery-labelauty.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/bootstrap-datepicker.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/jt-timepicker.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/datepair.js"></script>
<script src="<?php echo base_url();?>global/js/Plugin/jquery-strength.js"></script>
