<div class="panel-body col-lg-12">
    ...
    <table class="table table-bordered table-hover table-striped w-full" cellspacing="0" data-plugin = "dataTable">
        ...
        <tbody>
            ...
            <tr class="gradeA">
                ...
                <td class="actions">
                    ...
                    <button type ="button" data-target="#editCpVendorshipping<?php echo $a->id_cp;?>" data-toggle="modal" class="btn btn-outline btn-primary" ><i class="icon wb-edit"></i></button>
            ...
            <div class="modal fade" id="editCpVendorshipping<?php echo $a->id_cp;?>" aria-hidden="true" aria-labelledby="DaftarUser" role="dialog" tabindex="-1">
                                                ...
                                                switch($form_data["input".$b]["input"]){
                                                    ...
                                                    <div class = "form-group">
                                                        <div class="col-md-12 col-lg-12">
                                                            ...
                                                            <input type="<?php echo $form_data["input".$b]["type"];?>" name = "<?php echo $form_data["input".$b]["name"];?>" class="form-control" id="inputHelpText" placeholder = "<?php echo $form_data["input".$b]["placeholder"];?>" required value = "<?php echo $form_data["input".$b]["value"];?>">
                                                    ...
                                                    <div class = "form-group">
                                                        <div class="col-md-12 col-lg-12">
                                                            <!-- Example With Help -->
                                                            <h4 class="example-title"><?php echo $form_data["input".$b]["title"];?></h4>
                                                            <select name = "<?php echo $form_data["input".$b]["name"];?>" class="form-control" id="inputHelpText" required >
                                                            <?php 
                                                    ...
                                                    <div class = "form-group">
                                                        <div class="col-md-12 col-lg-12">
                                                            <!-- Example With Help -->
                                                            <h4 class="example-title"><?php echo $form_data["input".$b]["title"];?></h4>
                                                            <textarea name = "<?php echo $form_data["input".$b]["name"];?>" class="form-control" id="inputHelpText" required <?php if($form_data["input".$b]["rows"] != 0) echo "rows = ".$form_data["input".$b]["rows"];?> <?php if($form_data["input".$b]["cols"] != 0) echo "cols = ".$form_data["input".$b]["cols"];?> ><?php echo $form_data["input".$b]["value"];?></textarea>
                                                            <span class="text-help"><?php echo $form_data["input".$b]["help"];?></span>
                                                        </div>
                                                    </div>
                                                    <?php
        ...
        <a href = "<?php echo base_url();?>master/vendor/shipping" class = "btn btn-primary btn-outline">BACK</a>
</div>
